...
function buscaPorMatricula(matricula) {
    const urlBuscaM = `http://localhost:3000/aluno/${matricula}`;
    const options = {
        method: "GET",
        mode: "cors",
        cache: "no-cache"
...
function buscaPorNome(nome) {
    const urlBuscaN = `http://localhost:3000/aluno/search?nome=${nome}`;
    const options = {
        method: "GET",
        mode: "cors",
        cache: "no-cache"
...
function buscaPorTodos() {
    const urlBuscaT = `http://localhost:3000/aluno/todos`;
    const options = {
        method: "GET",
        mode: "cors",
        cache: "no-cache"
